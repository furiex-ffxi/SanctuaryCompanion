...
// Parse from the latest game text files (version 105)
const weapons = parseTsv('../D2SSharp/src/D2SSharp/Data/Txt/105/weapons.txt');
const armor = parseTsv('../D2SSharp/src/D2SSharp/Data/Txt/105/armor.txt');
const misc = parseTsv('../D2SSharp/src/D2SSharp/Data/Txt/105/misc.txt');
...
console.log('Successfully updated static_constant_data.js to version 105!');
